// Utilitaires DOM purs, sans dépendance vers iceElement ni iceStyle.
// Permet de briser la dépendance circulaire iceElement ↔ iceStyle.

import type { iXElement, OptionsCotesCSS, enumCote, enumCurseur, enumStyleBorderCSS, optionsAffichage } from './iceBase';
