...
module mChart
{
    ...
    export class xxCourbe<T> implements iXElement 
    {
        ...
        public constructor(options: OptionsCourbe<T>)
        {
            ...
            myThis.axSvg = new xSVG({ widthCustom: options.width, heightCustom: options.height, id: options.id, size: tailleIcone.Custom , class:options.class});
            ...
            options.titleLocalise != "" &&
                svg.append("text")
                    ...
                    .text(new xLString(options.titleLocalise).text);
