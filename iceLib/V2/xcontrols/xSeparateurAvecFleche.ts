...
class xSeparateurAvecFleche implements iXElement
{
    ...
    {
        let mythis: xSeparateurAvecFleche = this;
        mythis.option = option;

        // Création des classes
        let classes: string = "xSeparateurAvecFleche ";
        ...
        mythis.grid.append([
            ...
            new xxGridItem({
                ...
                content: new xSeparateur(option.optionsxSeparateur),
