...
export class itemRadioButton<T>
{
    ...
    public static readonly classSelected: string = "ice2RadioButtonItemSelected";
    ...
    public divHost: iceDiv;
    public boutonAssocie: ice2Bouton;
...
export class ice2RadioButton<T> implements iXElement
{
    ...
    // Items //
    private myList: ice2ListWrapper<itemRadioButton<T>>;
    ...
    {
        let myThis: ice2RadioButton<T> = this;
        ...
        // Generate Class //
        let classeDefaut: string = "ice2RadioButton ";
        ...
        {*/
            ...
            myThis.myList = new ice2ListWrapper<itemRadioButton<T>>({
                class: classeDefaut,
    ...
    private createButton(ici: iXElementHolder, item: itemRadioButton<T>, myThis: ice2RadioButton<T>)
    {
        item.jqHostButton = ici;
        item.divHost = new iceDiv({ class: "ice2RadioButtonItem" });
        ...
        {
            iceStyle.setBorder(item.divHost, { Gauche: 5 });
            iceStyle.setCouleurBorder(item.divHost, item.couleurBorder, enumCote.gauche);
        }
        ...
        switch (myThis.typeBouton)
        {
            ...
            case ETypeBouton.boutonClassique:
                item.divHost.asHolder.append(new ice2Bouton({
                    id: item.id,
                    binding: {
                    ...
                    class: "ice2RadioButtonClassique" + (boutonSeul? " boutonSeul":""),
                    click: function (cb)
                    {
            ...
            case ETypeBouton.boutonWrapper2:
                let btnWrapper2: ice2Bouton = new ice2Bouton({
    ...
    /*private ajouterItemToMyGrid(elements: itemRadioButton<T>[])
    {
        ...
        {
            let tdiv: iceDiv = new iceDiv({ class: "ice2GridItem", id: item.id });
    ...
    */
    /*private supprimerItemFromMyGrid(elements: itemRadioButton<T>[])
    {
        ...
        {
            let gridItem: ice2GridItem = myThis.myGridItems.find(gi => gi.content.y.id == item.id);
    ...
    //** Set le texte en mode ice2Bouton (ButtonWapper2)*/
    ...
    public setVisibility(s: enumVisibility)
    {
        ...
        switch (s)
        {
            case enumVisibility.afficher:
                affichericeElements(/*myThis.myGrid != null ? myThis.myGrid :*/ myThis.myList);
                break;
            case enumVisibility.masquer:
                cachericeElements(/*myThis.myGrid != null ? myThis.myGrid : */myThis.myList, false);
                break;
            case enumVisibility.masquerAvecCollapse:
                cachericeElements(/*myThis.myGrid != null ? myThis.myGrid :*/ myThis.myList, true);
                break;
            default:
                affichericeElements(/*myThis.myGrid != null ? myThis.myGrid :*/ myThis.myList);
        }
