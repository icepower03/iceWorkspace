...
class BoxerDetail {
    ...
    private page: ice2PageWrapper;
    private boxer: ice2Boxer;

    public constructor(composant: Function, options?: any) {

        //creation de la page
        this.page = new ice2PageWrapper({ titleLocalise: "", withFooter: true });
        const nameMatch = /(?:class|function)\s+(\w+)/.exec(composant.toString());
        this.page.TitreVariable = nameMatch ? nameMatch[1] : (composant.name ?? "");
        ...
        //création du tableau
        this.page.zonePrincipale.ice2Tableau<Methode>({
            data: methodElements,
            columns: [
                {
                    titleVariable: "Nom",
        ...
        //creation du boxer
        this.boxer = new ice2Boxer({ initContent: this.page });
        this.boxer.afficher();
    }
...
export class ice2ShowRoom implements iXElement {
    pageShowRoom: ice2PageWrapper;
    ...
    constructor(options: optionsShowRoom) {
        ...
        let mythis: ice2ShowRoom = this;

        mythis.pageShowRoom = options.page;
        mythis.pageShowRoom.addClass('ice2Showroom');

        let dataTabx: ElementSR[] = [];
        let dataTabice2: ElementSR[] = [];
        ...
        function ajouter(inT: string, inC: string, inR: (ici: xElementHolder) => void, nbX: number, classe?: Function) {
            if (nbX == 1)
                ...
                dataTabice2.push(new ElementSR(inT, inC, inR, classe));
            else if (nbX == 4)
        ...
        let divChartBar: iceDiv = new iceDiv({ id: "div_contenant_chart_bar" });
        let divChartCamembert: iceDiv = new iceDiv({ id: "div_contenant_chart" });
        let tableau_xElement: ice2TableauWrapper<ElementSR> = new ice2TableauWrapper<ElementSR>({
            id: 'showroom_tab',
            data: [],

            filtreTexte: (p, item) => { return iceOutils.rechercheString(p, [item.commentaire, item.titre]); },
            columns: [{
                titleVariable: 'composant',
                renderMethod: function (place: xElementHolder, valeur: ElementSR, lw: ice2TableauLigneWrapper<ElementSR>) {
                    if (valeur.classe != undefined)
                        place.append(new ice2Bouton({ titleVariable: "afficher détails", textVariable: valeur.titre, click: function (cb) { cb(); new BoxerDetail(valeur.classe); } }))
                    else
            ...
            {
                titleVariable: 'commentaire', renderMethod: function (place: xElementHolder, valeur: ElementSR, lw: ice2TableauLigneWrapper<ElementSR>) {
                    place.xspan({ textVariable: valeur.commentaire });
                    place.addClass("col_commentaire");
                }
            },
            {
                titleVariable: 'sample', renderMethod: function (place: xElementHolder, valeur: ElementSR, lw: ice2TableauLigneWrapper<ElementSR>) {
                    valeur.render(place);
                    place.addClass("col_sample");
                }
            }]
        });
        let tableau_ice2Element: ice2TableauWrapper<ElementSR> = new ice2TableauWrapper<ElementSR>({
            id: 'showroom_tab',
            data: [],
            filtreTexte: (p, item) => { return iceOutils.rechercheString(p, [item.commentaire, item.titre]); },
            columns: [{
        ...
        let tableau_DockPanel: ice2TableauWrapper<ElementSR> = new ice2TableauWrapper<ElementSR>({
            id: 'showroom_tab',
            data: [],
            columns: [{
                titleVariable: 'composant',
        ...
        let tableau_BoutonWapper2: ice2TableauWrapper<ElementSR> = new ice2TableauWrapper<ElementSR>({
            id: 'showroom_tab',
            data: [],
            columns: [{
                titleVariable: 'composant',
        ...
        let tableau_ListeIcones: ice2TableauWrapper<ElementSR> = new ice2TableauWrapper<ElementSR>({
            id: 'showroom_tab',
            data: [],
            columns: [{
                titleVariable: 'composant',
        ...
        let tableau_charts: ice2TableauWrapper<ElementSR> = new ice2TableauWrapper<ElementSR>({
            id: 'showroom_charts',
            data: [],
            columns: [{
                titleVariable: 'composant',
        ...
        let tableau_bindings: ice2TableauWrapper<ElementSR> = new ice2TableauWrapper({
        ...
        {
            class: "ice2TabControlShowroom",
            tabChange: function (i: ice2TabItem) {
                iceOutils.afficherMessageAlertify("changement d'onglet", ETypeAlertify.log);
            },
            initElements: [
                {
                    textVariable: 'iceElements',
                    addContent: function (ici: xElementHolder) {
                        ici.append(tableau_xElement);
                    }
                },
                {
                    textVariable: 'ice2Elements',
                    addContent: function (ici: xElementHolder) {
                        ici.append(tableau_ice2Element);

                        //On attend le rendu des cellules du tableau puis on lance le rendu des rdv du ice2Planneur
                        setTimeout(function () {
        ...
        mythis.pageShowRoom.zonePrincipale.ice2TabControl(optionsTabPage);

        let ct: ice2RadioButton<string>;
        ...
        o = {
            ...
            valueChange: function (val: string) {
                iceOutils.afficherMessageAlertifyLog(val); ct.ajouterItems([new itemRadioButton<string>({ icone: new IconeP12(enumIconeP12.action_admission), valeur: "ajout", libelleVariable: "ajout" }),
                ]);
            },
            initElements: [
        ...
        ajouter('iceCouleur', 'conteneur avec option de couleur', function (ici: xElementHolder) {
            class Couleur {
                id: number;
                codeCouleur: string;
                pastelle: boolean;
            ...
            let plop: ice2ListeDeroulante<Couleur> = new ice2ListeDeroulante<Couleur>({
                donnees: mesCouleur,
                renderSelected: function (ici, maCouleur, cbOuvrir) {
                    ici.append(new iceCouleur({
            ...
            let labelComboCouleur: ice2LabelContainer = new ice2LabelContainer({
                textVariable: 'sélectionner une couleur',
                initContent: plop
            });
            ici.append(labelComboCouleur);

            let it: iceCouleur = new iceCouleur({
                //textVariable: 'hello world',
                codeCouleur: '800C7D',
                title: 'test de couleur',
                //click: function ()
                //{
                //    iceOutils.afficherMessageAlertify("hello world", ETypeAlertify.success);
                //}
            });
            let labelCouleurSimple: ice2Label = new ice2Label({
                textVariable: 'affichage de couleur',
            });

            let wrappanelCouleurSimple = new ice2WrapPanel({
                initContent: [
                    labelCouleurSimple,
                    it,
                    new ice2Bouton({
        ...
        ajouter('xinputFile', 'Champ de saisie de fichier', function (ici: xElementHolder) {
            let it: iceDiv = new iceDiv();
            let f = new iceInputFile({
                ValueChange: function (valeur: File, binary: string) {
                    it.asHolder.empty().ice2StackPanel({
                        initContent: [
                            new ice2LabelContainer({
                                textVariable: "fichier",
                                initContent: new iceSpan({ textVariable: valeur.name })
                            }),
                            new ice2LabelContainer({
                                textVariable: "taille",
                                initContent: new iceSpan({ textVariable: "" + valeur.size })
                            }),
                            new ice2LabelContainer({
                                textVariable: "type",
                                initContent: new iceSpan({ textVariable: valeur.type })
                            })
                        ]
                    });
                },
        ...
        ajouter('xinputTime', 'Champ de saisie texte de type heure', function (ici: xElementHolder) {
            ici.append(new xInputTime({
                value: new iceTime(15, 45),
                ValueChange: function (a: iceTime) { iceOutils.afficherMessageAlertifySuccess(a.getString()) }
            }));
        ...
        ajouter('xinputDate', 'Champ de saisie texte de type date', function (ici: xElementHolder) {
            ...
            let inputPicker = new iceInputDate({
        ...
        ajouter('xinputDate', 'Champ de saisie graphique de type date (typeAffichage:enumTypeAffichePicker.InLine)', function (ici: xElementHolder) {
            ...
            let id: iceDiv = new iceDiv();
            let id2: iceDiv = new iceDiv();
            let inputPicker: iceInputDate = new iceInputDate({
        ...
        ajouter('xinputDateAndTime', 'Champ de saisie texte de type date/heure', function (ici: xElementHolder) {
            ...
            let id = new ice2Label({ textVariable: "" });
        ...
        ajouter('iceImg', 'Permet d\'afficher une image via son URL', (ici: xElementHolder) => {
            let img = new iceImg({
        ...
        ajouter('ice2Grid', 'ice2Grid', function (ici: xElementHolder) {

            let g = new ice2Grid({ colonnes: ['1', '2', '3', '1'], lignes: ['1', '2', '1'] });
            let div1 = new ice2GridItem({
                class: "ice2griditem1",
                rowStart: 1,
                colStart: 4,

                nbCols: 2,
                content: new ice2Label({ textVariable: 'un' })
            });
            let div2 = new ice2GridItem({
                class: "ice2griditem2",
                rowStart: 2,
                colStart: 1,

                nbCols: 1,
                content: new ice2Label({ textVariable: 'deux' })
            });
            let div3 = new ice2GridItem({
                class: "ice2griditem3",
                rowStart: 3,
                colStart: 1,


                content: new ice2Label({ textVariable: 'trois' })
            });
            let div4 = new ice2GridItem({
                class: "ice2griditem4",
                rowStart: 4,
                colStart: 1,

                content: new ice2Label({ textVariable: 'quatre' })
            });
            let div5 = new ice2GridItem({
                class: "ice2griditem5",
                rowStart: 5,
                colStart: 1,

                nbCols: 4,
                content: new ice2Label({ textVariable: 'cinq' })
            });
            let div6 = new ice2GridItem({
                class: "ice2griditem6",
                rowStart: 2,
                colStart: 2,
                nbRows: 4,

                content: new ice2Label({ textVariable: 'six' })
            });
        ...
        ajouter('ice2ContainerEvent', 'Conteneur avec gestion des événements (click, survol, click droit)', function (ici: xElementHolder) {
            let container: ice2ContainerEvent = new ice2ContainerEvent({
                initContent: new ice2Label({ textVariable: "lorem ipsum dolor sit amet consegetur" }),
                onClick: function (cb) {
                    cb();
                    iceOutils.afficherMessageAlertify("Click détecté !", ETypeAlertify.log);
                },
        ...
        }, 2, ice2ContainerEvent);

        ajouter('ice2ListCheckBox', 'Liste à choix multiples, renvoie la liste des éléments sélectionnés', function (ici: xElementHolder) {
            ...
            let list = new ice2ListCheckBox<Ingredient>({
                data: donnees,
                equals: function (a, b) { return a.id == b.id },
                renderItem: function (ici, item) {

                    ici.append(new ice2Label({ textVariable: item.Nom }));
                },
                renderTitre: function (ici) {
                    ici.append(new ice2Label({ textVariable: "Ingrédients", type: enumTypeLabel.titre, class: "titre" }));
                },
                valueChange: function (liste) {
                    ...
                    iceOutils.afficherMessageAlertify("Elément(s) sélectionné(s) : " + elts, ETypeAlertify.log);
                },
        ...
        ajouter('ice2RadioButton', 'Boutons radio par défaut en mode horizontal', function (ici: xElementHolder) {
            ct = new ice2RadioButton(o);
            ici.append(ct);
        ...
        ajouter('ice2RadioButton', 'Boutons radio en mode vertical avec présélection', function (ici: xElementHolder) {
            ...
            ici.ice2RadioButton(o);

        }, 2, ice2RadioButton);



        ajouter('ice2RadioButton', 'Boutons avec displayOnlySelected true vertical', function (ici: xElementHolder) {
            o.typeOrientation = enumTypeOrientation.vertical;
        ...
        ajouter('ice2RadioButton', 'Boutons avec displayOnlySelected true horizontal', function (ici: xElementHolder) {
        ...
        ajouter('ice2RadioButton', 'Boutons avec displayOnlySelected true horizontal avec présélection', function (ici: xElementHolder) {
            o.typeOrientation = enumTypeOrientation.horizontal;
            o.displayOnlySelected = true;
        ...
        ajouter('ice2RadioButton', 'Boutons en mode Boutons classiques', function (ici: xElementHolder) {
        ...
        ajouter('ice2InputUploadImage', 'upload image mode selfie', function (ici: xElementHolder) {
            let image = new ice2ImageTabByte({ typeAffichage: enumTypeImage.domImage, tabByte: '' });

            let a = new ice2InputUploadImage({
                appareilPhoto: "selfie",
                ValueChange: s => { image.SetTabByte(s, enumTypeImage.domImage); }
            });

            ici.append(a).append(image);
        }, 2, ice2InputUploadImage);



        ajouter('ice2ChoixCouleur (nuancier)', 'choix de couleur via nuancier prédéfini', function (ici: iXElementHolder) {
            ici.append(new ice2ChoixCouleur({ choixCouleurLibre: false, value: '000000', ValueChange: function (s) { ici.y.style.backgroundColor = '#' + s; } }))
        }, 2, ice2ChoixCouleur);

        ajouter('ice2ChoixCouleur (libre)', 'choix de couleur libre via <input type="color"> natif', function (ici: iXElementHolder) {
            let binding = new BindableObject();
            binding.Value = 'ff3333';
            ici.append(new ice2ChoixCouleur({
            ...
            initElements: [
                {
                    ...
                    addContent: function (ici: xElementHolder) {
                        ici.ice2Label({ textVariable: 'ceci est le 1er onglet' });
                    }
                },
                {
                    textVariable: 'test onglet 2',
                    addContent: function (ici: xElementHolder) {
                        ici.ice2Label({ textVariable: 'ceci est le 2eme onglet' });
                    }
                },
                {
                    textVariable: 'test onglet 3r',
                    addContent: function (ici: xElementHolder) {
                        ici.ice2Label({ textVariable: 'ceci est le 3eme onglet' });
                    }
                },
                {
                    //textVariable: 'test onglet 2',
        ...
        ajouter('ice2TabControl', 'Zone d\'affichage avec onglets mode horizontal - Style arrondi', function (ici: xElementHolder) {
            ...
            ici.ice2TabControl(optionsTab);


        }, 2, ice2TabControl);

        ajouter('ice2Tabcontrol', 'Zone d\'affichage avec onglets mode vertical', function (ici: xElementHolder) {
        ...
        ajouter('ice2TabControl', 'onglets que l\'on peut fermer', function (ici: xElementHolder) {

            let tabcontrol: ice2TabControl = new ice2TabControl({
            ...
            tabcontrol.ajouterOnglet({
                addContent: function (ici) {
                    ici.append(new ice2Label({ textVariable: "Onglet A" }));
                },
                ...
                .ajouterOnglet({
                    addContent: function (ici) {
                        ici.append(new ice2Label({ textVariable: "Onglet B" }));
                    },
                ...
                .ajouterOnglet({
                    addContent: function (ici) {
                        ici.append(new ice2Label({ textVariable: "Onglet C" }));
                    },
        ...
        ajouter('ice2TabControl', 'Bouton d\'ajout d\'onglets prédéfinis', function (ici: xElementHolder) {
        ...
        ajouter('ice2TreeTabControl', 'Gestion d\'un menu', function (ici: xElementHolder) {
            let treeTabControl: ice2TreeTabControl = new ice2TreeTabControl({
                class: "MenuZeus",
                onglets:
                    [{
                        ...
                        onglets: [{
                            ...
                            addContent: function (icimeme: xElementHolder) {
                                icimeme.append(new iceIFrame({ src: '' }));
                            }
                        },
                        {
        ...
        }, 2, ice2TreeTabControl);


        ajouter('ice2Boxer', 'Affichage d\'une fenêtre isolée dans un écran, le click en dehors de cette fenêtre ferme le ice2Boxer', function (ici: xElementHolder) {
            let myBox: ice2Boxer = new ice2Boxer({

                afterClose: function () { alert('afterClose'); },
                beforeShow: function () { alert('beforeShow'); },
                initContent: new ice2Label({ textVariable: 'test' })
            });

            ici.append(new ice2Bouton({ textVariable: 'ouvrir', titleVariable: 'ouvrir', click: function (cb) { myBox.afficher(); cb(); } }));
            ;
        }, 2, ice2Boxer);

        ajouter('ice2BloqueEcran', "Le ice2BloqueEcran bloque tout l'écran", function (ici: xElementHolder) {
            ici.append(new ice2Bouton({
                titleVariable: 'ouvrir', textVariable: 'ouvrir', click: function (cb) {
                    let myBox: ice2BloqueEcran = new ice2BloqueEcran({
        ...
        ajouter('ice2Boxer', 'Le click en dehors de cette fenêtre ne ferme pas le ice2Boxer (mode:modal)', function (ici: xElementHolder) {
            let myBox: ice2Boxer = new ice2Boxer({
                modal: true,
                //afterClose: function () { alert('afterClose'); },
                //beforeShow: function () { alert('beforeShow'); },
            ...
            ici.append(new ice2Bouton({ titleVariable: 'ouvrir', textVariable: 'ouvrir', click: function (cb) { myBox.afficher(); cb(); } }));
            ;
        }, 2, ice2Boxer);

        ajouter('ice2Boxer', 'Exemple d\'une iframe avec préchargement', function (ici: xElementHolder) {
            let myBox: ice2Boxer = new ice2Boxer({
                initContent: new iceIFrame({ src: 'https://www.google.fr' })
            });
        ...
        ajouter('ice2Boxer', 'Exemple d\'une iframe qui se charge à l\'ouverture du boxer', function (ici: xElementHolder) {
            let myBox: ice2Boxer = new ice2Boxer({
                beforeShow: function (ceBoxer: ice2Boxer) {
                    ceBoxer.vider();
                    ceBoxer.ajouterContenu(new iceIFrame({ src: 'https://www.google.fr' }));
                }
            });
        ...
        ajouter('ice2Boxer', 'Boxer avec choix de la taille (ex: m ) (enum : s, m , l)', function (ici: xElementHolder) {
            let myBox: ice2Boxer = new ice2Boxer({
            ...
            ici.append(new ice2Bouton({ titleVariable: 'ouvrir', textVariable: 'ouvrir', click: (cb) => { myBox.afficher(); cb(); } }));
        }, 2, ice2Boxer);
        ...
        ajouter('ice2CheckBox', 'Case à cocher partielle', (ici) => {
            let checkbox_intermediaire = new ice2CheckBox({
                value: null,
                canbePartiel: true,
                ValueChange: (value) => {
                    console.log(value);
        ...
        ajouter('ice2CheckBox', 'Case à cocher', function (ici: xElementHolder) {
            let i = new iceDiv();
            ici.ice2CheckBox({
                ValueChange: function (valeur: boolean) {
                    i.y.textContent = '' + valeur;
        ...
        ajouter('ice2CheckBox', 'Case à cocher en mode slider', function (ici: xElementHolder) {
            let i = new iceDiv();
            ici.ice2CheckBox({
        ...
        ajouter('ice2CheckBox', 'Case à cocher en mode slider avec une initialisation de l\'état', function (ici: xElementHolder) {
            let i = new iceDiv();
            ici.ice2CheckBox({
                value: true,
                typeCheckbox: enumTypeCheckbox.slide,
        ...
        ajouter('ice2CheckBox', 'Case à cocher inactive', function (ici: xElementHolder) {
            let i = new iceDiv();
            ici.ice2CheckBox({
                value: true,
                inactif: true,
        ...
        ajouter('ice2CheckBox', 'Case à cocher en mode texte', function (ici: xElementHolder) {
            let i = new iceDiv();
            ici.ice2CheckBox({
                value: true,
        ...
        ajouter('ice2CheckBox', "Case à cocher en mode image", function (ici: xElementHolder) {
            let i = new iceDiv();
            ici.ice2CheckBox({
                value: true,
        ...
        ajouter('ice2Bouton', 'ice2Bouton', ici => {
            ici.append(new ice2Bouton({
                titleVariable: "",
                click: (cb) => {
                    iceOutils.afficherMessageAlertifyLog("Bouton home type default");
                    cb();
                }
            }))
        ...
        ajouter('ice2Bouton', 'ice2Bouton avec iconeSvg, typeBouton: enumtypeBouton.Standard, positionIcon: enumPosition.Right', ici => {
            ici.append(new ice2Bouton({
                ...
                titleVariable: "test",
                click: cb => {
                    iceOutils.afficherMessageAlertifyLog("Bouton home type svg cliqué")
                    cb();
                }
            }))
        ...
        ajouter('ice2Bouton', 'ice2Bouton avec iconeSvg, type: labelled, with shiftClick, with  optionLabelled: optionLabel', ici => {
            ici.append(new ice2Bouton({
                icone: new IconeSvg(enumIconeSvg.home),
                typeBouton: enumTypeBouton.TexteHorsBouton,
                titleVariable: "test",
                shiftClick: cb => {
                    iceOutils.afficherMessageAlertifySuccess("shiftClik exécuté");
                    cb();
                },
                optionsLabel: {
                    textVariable: "test",
        ...
        ajouter('ice2Bouton', 'ice2Bouton avec iconeSvg, type: labelled, with shiftClick, with  optionLabelled: optionLabel', ici => {
            ici.append(new ice2Bouton({
                ...
                shiftClick: cb => {
                    iceOutils.afficherMessageAlertifySuccess("shiftClik executé");
                    cb();
                },
        ...
        ajouter('ice2Bouton', 'confirm: { enumComportementBouton.ActionAConfirmer }', ici => {
            ici.append(new ice2Bouton({
                icone: new IconeSvg(enumIconeSvg.home),
                confirm: {
        ...
        ajouter('ice2Bouton', 'confirm: { enumComportementBouton.ActionDifferee }', ici => {
            ici.append(new ice2Bouton({
                icone: new IconeSvg(enumIconeSvg.home),
                titleVariable: "Ah oui oui ",
                confirm: {
        ...
        ajouter('ice2Bouton', 'confirm: { enumComportementBouton.ValidationBloquante, stringConfirm: () => { return "test" } }', ici => {
            ici.append(new ice2Bouton({
                icone: new IconeSvg(enumIconeSvg.home),
                titleVariable: "Ah oui oui ",
                confirm: {
        ...
        //ajouter('ice2Bouton', 'avec état enregistrer: utilisation dans la méthode click', ici => {
        //    ici.append(new ice2Bouton({
        ...
        ajouter('ice2Bouton', 'ice2Bouton avec old icone', ici => {
            ici.append(new ice2Bouton({
                titleVariable: "Ah oui oui ",
                icone: new IconeP12(enumIconeP12.ice2RouteContainer_Home),
                textVariable: "Home",
                click: cb => {
                    iceOutils.afficherMessageAlertifyLog("Bouton home type old icone cliqué");
                    cb();
                }
            }))
        ...
        ajouter('ice2Bouton', 'ice2Bouton disabled', ici => {
            ici.append(new ice2Bouton({
                ...
                disabled: true,
                click: cb => {
                    iceOutils.afficherMessageAlertifyLog("ce message ne doit jamais apparaitre : le bouton est désactivé.");
                    cb();
                }
            }))
        ...
        ajouter('ice2InputNumeric', 'Permet de creer un xInpuT text avec une option numerique', ici => {
            ici.append(new ice2InputNumerique({
                ValueChange: (val) => {
                    iceOutils.afficherMessageAlertifySuccess(val.toString());
                },
                value: 12
            }))

        }, 2, ice2InputNumerique)

        ajouter('ice2InputNumeric', 'Permet de créer un xInpuT text avec une option numérique', ici => {
            ici.append(new ice2InputNumerique({
                plusMinusButton: {},
                ValueChange: (val) => {
                    iceOutils.afficherMessageAlertifySuccess(val.toString());
        ...
        ajouter('ice2Autocomplete', 'Permet de faire une recherche dans une liste via le input', function (ici: xElementHolder) {

            let divResultat = new iceDiv({ class: 'resultat_autocomplete' });
            ici.append(divResultat);

            ici.ice2AutoComplete<fruit>({
                typeValue: null,
                ...
                valueChange: function (f: fruit) {
                    divResultat.asHolder.empty()
                        .ice2LabelContainer({
                            textVariable: new iceLString('nom').text + ' : ',
                            initContent: new iceDiv({ textVariable: f.nom })
                        })
                        .ice2LabelContainer({
                            textVariable: new iceLString('couleur').text + ' : ',
                            initContent: new iceDiv({ textVariable: f.couleur })
                        })
                        .ice2LabelContainer({
                            textVariable: new iceLString('vitamines').text + ' : ',
                            initContent: new iceDiv({ textVariable: "" + f.vitamines })
                        });
                }
            });
        ...
        ajouter('ice2Autocomplete', 'Si la recherche ne matche pas un choix null est sélectionné (libelleNullChoice:aucun)', function (ici: xElementHolder) {
        ...
        ajouter('ice2ListChoix', 'Liste déroulante', function (ici: xElementHolder) {
            let optionsChoix: OptionsSelect = {};

            optionsChoix.listeValeurs = listeVal;

            ici.ice2ListChoix(optionsChoix);
        }, 2, ice2ListChoix);

        ajouter('ice2ListChoix', 'Liste déroulante avec un choix par défaut', function (ici: xElementHolder) {
        ...
        ajouter('ice2Menu', 'Menu avec catégorisation et recherche', function (ici: xElementHolder) {
            ...
            ici.ice2Menu(optionsMenu);
        }, 2, ice2Menu);

        ajouter('ice2Menu', 'Menu avec catégorisation sans recherche', function (ici: xElementHolder) {
            let optionsMenu: OptionsMenu = {
                contenu:
                    [{
                        icone: new IconeP12(enumIconeP12.admin_agendas),
        ...
        ajouter('ice2Arbre', 'ice2Arbre', ici =>
            ici.append(new ice2Arbre({
                donnees: obs,
                defaultvalue: null,
                valueChange: v => {
                ...
                renderDetail: (v, place, select) => {
                    let container: ice2ContainerEvent = new ice2ContainerEvent({
                        initContent: new ice2LabelContainer({ textVariable: v.modeCuisson, initContent: new ice2Label({ textVariable: v.typeFarine }) }),
                        onClick: (cb) => {
                            select(v);
                            cb();
                        }
                ...
                renderTitre: (v, place) => {
                    place.append(new ice2LabelContainer({ textVariable: v.modeCuisson, initContent: new ice2Label({ textVariable: v.typeFarine }) }));
        ...
        ajouter('ice2List<T>', 'Liste d\'éléments', function (ici: xElementHolder) {


            let monice2ListWrapper: ice2ListWrapper<Dessert> = new ice2ListWrapper<Dessert>({

                donnees: mesDesserts.splice(0, 10),
                renderItem: function (ici, item: Dessert) {

                    ici.ice2LabelContainer({ textVariable: "farine:" + item.farine })
                        .ice2LabelContainer({ textVariable: "cuisson:" + item.modeCuisson })
                        .ice2LabelContainer({ textVariable: "oeufs:" + item.oeufs })
                        ...
                        .append(new ice2Bouton({
                            ...
                            click: function (cb) {
                                monice2ListWrapper.supprimerItem(item);
                                cb();
                            }
                        }));
            ...
            ici.append(monice2ListWrapper)
                ...
                .append(new ice2Bouton({
                    ...
                    click: function (cb: () => void) {
                        monice2ListWrapper.ajouterItems(mesDesserts.slice(10, 20));
                        cb();
                    }
                }))
                .append(new ice2Bouton({
            ...
            ici.append(new ice2Bouton({
                titleVariable: 'set filtre', textVariable: 'appliquer filtre', click:
                    cb => {
                        cb();
                        monice2ListWrapper.setFiltre((d) => {
                            return d.farine < 255;
                        })
                    }
            }));
            ...
            ici.append(new ice2Bouton({
                titleVariable: 'filtrer', textVariable: 'filtrer la liste', click:
                    cb => {
                        cb();
                        monice2ListWrapper.filtrer();
                    }
            }));
        }, 2, ice2ListWrapper);

        ajouter('ice2ListDeroulante', 'Liste déroulante avec un choix par défaut, mode classique', function (ici: xElementHolder) {
            let listeDessert = new ice2ListeDeroulante<Dessert>({
                defaultValue: null,
                donnees: mesDesserts,
        ...
        }, 2, ice2ListeDeroulante);

        ajouter('ice2ListDeroulante', 'Liste déroulante lecture seule', function (ici: xElementHolder) {
        ...
        ajouter('ice2ListDeroulante', 'fonction ouverture ', function (ici: xElementHolder) {
            let listeDessert = new ice2ListeDeroulante<Dessert>({
                defaultValue: null,
                donnees: mesDesserts,
                renderSelected: function (ici, monDessert, cbOuvrir) {
        ...
        ajouter('ice2ListDeroulante', 'Liste déroulante avec titre mobile', function (ici: xElementHolder) {
            let listeDessert = new ice2ListeDeroulante<Dessert>({
                defaultValue: null,
                donnees: mesDesserts,
        ...
        ajouter('ice2ListDeroulanteSimple', 'Liste déroulante simple avec un choix defaut [le comportement est fixé: code/libellé sert juste à refactoriser des anciens composants, préférer ice2ListeDeroulante qui lui est très personnalisable et pas plus compliqué]', function (ici: xElementHolder) {

            ici.ice2LabelContainer({
                textVariable: 'choisissez un dessert', initContent:
                    new ice2ListeDeroulanteSimpleNePlusUtiliser<Dessert>({
        ...
        }, 2, ice2ListeDeroulanteSimpleNePlusUtiliser);

        ajouter('ice2ListeSelection', "Permet de choisir une sélection d'éléments dans une liste", ici => {
            class legumes {
            ...
            let listeChoixTest = new ice2ListeSelection<legumes>({
        ...
        }, 2, ice2ListeSelection);


        ajouter('ice2Tableau<T>', 'Tableau (avec ice2Tableau<T>.setPagination(1)', function (ici: xElementHolder) {
            ...
            let w: ice2TableauWrapper<Dessert> = new ice2TableauWrapper<Dessert>({

                id: "ice2TableauExemple",
                clickLigne: function (d: Dessert, lw: ice2TableauLigneWrapper<Dessert>) {
                ...
                columns: [
                    {
                        ...
                        renderMethod: function (place: xElementHolder, valeur: Dessert) {
                            place.append(
                                new ice2Label({ textVariable: valeur.farine + ' g' })
                            ).append(
                                new ice2Bouton({
                        ...
                        group: (place, a: Dessert): void => { place.append(new iceDiv({ textVariable: a.typeFarine })); },
                    ...
                    },
                    {
                        ...
                        renderMethod: function (place: xElementHolder, valeur: Dessert, lw: ice2TableauLigneWrapper<Dessert>) {
                            place.append(new iceDiv({ textVariable: valeur.modeCuisson }))
                                .append(new ice2Bouton({
            ...
            let monTableau: ice2TableauWrapper<Dessert>
            ...
            ici.append(w)
                ...
                .append(new ice2Bouton({
                    ...
                    icone: new IconeP12(enumIconeP12.action_ajouter),
                    click: function (cb) {
                        w.ajouterColonne(new ice2Colonne<Dessert>({
                            titleVariable: 'oeufs',
                            renderMethod: function (place: xElementHolder, valeur: Dessert) {
                ...
                ;
        }, 2, ice2TableauWrapper);

        ajouter('ice2Tableau<T>', 'Tableau avec regroupement global', function (ici: xElementHolder) {
            ...
            let w: ice2TableauWrapper<Dessert> = new ice2TableauWrapper<Dessert>(
                {
                    ...
                    groupeGlobal: {
                        group: (place: xElementHolder, a: Dessert, b: Dessert): void => {
                            let stack: ice2StackPanel = new ice2StackPanel({});
                            place.append(stack);
                            if (b == null || a.modeCuisson != b.modeCuisson) {
                                stack.append(new ice2Label({ textVariable: a.modeCuisson }));
                                stack.append(new ice2Label({ textVariable: a.typeFarine }));
                            }
                            else {
        ...
        ajouter("ice2Tableau", "Avec utilisation d'une fonction de rendu pour les titres des colonnes", (ici) => {
            let tableau_rendertitle = new ice2TableauWrapper<Dessert>({
                data: mesDesserts,
                pagination: 10,
                columns: [
                    {
                        renderTitle: (place) => {
                            place.append(new ice2LabelContainer({
                        ...
                        renderTitle: (place) => {
                            place.append(new ice2LabelContainer({
                                ...
                                initContent: new ice2CheckBox({
                                    value: false,
                                    ValueChange: value => {
                                        iceOutils.afficherMessageAlertifySuccess("Vous avez cliqué sur la checkbox");
                                    }
                                })
                            }))
                        },
                        renderMethod: (place: xElementHolder, valeur: Dessert, lw: ice2TableauLigneWrapper<Dessert>) => {
                            place.xdiv({ textVariable: valeur.modeCuisson })
                                .append(new ice2Bouton({
        ...
        ajouter("ice2Tableau", "Avec utilisation du detail par ligne", ici => {
            let w = new ice2TableauWrapper({
                data: [],
                pagination: 10,
                exportPDF: {
                    PdfModePaysage: false,
        ...
        ajouter("ice2Tableau", "Avec utilisation du ClickLigne", ici => {
            let w = new ice2TableauWrapper({
                data: [],
                columns: [
                    {
        ...
        //ajouter('ice2Label', 'Permet d\'afficher du texte', function (ici: xElementHolder) { ici.ice2Label({ textVariable: 'bonjour', icone: new IconeP12(enumIconeP12.action_urgent) }); }, 2, ice2Label);
        ajouter('ice2Label', 'Permet d\'afficher du texte en mode bloc (type:bloc)', (ici => {
            ici.append(new ice2Label({
...
lignes `
        ...
        ajouter('ice2Label', 'Permet d\'afficher du texte en mode titre (type:titre)', function (ici: xElementHolder) { ici.ice2Label({ textVariable: 'bonjour', type: enumTypeLabel.titre }); }, 2, ice2Label);
        ajouter('ice2Label', 'Permet d\'afficher du texte en mode important (type:important)', function (ici: xElementHolder) { ici.ice2Label({ textVariable: 'bonjour', type: enumTypeLabel.important }); }, 2, ice2Label);
        ajouter('ice2Label', 'Permet d\'afficher du texte en mode description (type:description)', function (ici: xElementHolder) { ici.ice2Label({ textVariable: 'bonjour', type: enumTypeLabel.description }); }, 2, ice2Label);
        let labelExSubrillance: ice2Label = new ice2Label({ textVariable: 'bonjour' });
        ajouter('ice2Label', 'Permet d\'afficher du texte et de surligner une text donné (label.setSurbrillance(\'njo\'))', function (ici: xElementHolder) { ici.append(labelExSubrillance); }, 2, ice2Label);
        labelExSubrillance.setSurbrillance('njo');
        ajouter('ice2Label', 'Permet d\'afficher une durée en faisant ressortir les chiffres utiles (type:temps)', function (ici: xElementHolder) {
            ici.ice2Label({ textVariable: '00h30', type: enumTypeLabel.temps });
        }, 2, ice2Label);

        ajouter('ice2LabelContainer', 'Imbrication de ice2LabelContainer', function (ici: xElementHolder) {
            ici.ice2LabelContainer({
                textVariable: 'toto1',
                optionsAffichage: { positionDuContenu: enumPositionDuContenu.bas },
                initContent: new ice2LabelContainer({
                    textVariable: 'toto2',
                    initContent: new ice2LabelContainer({
                        textVariable: 'toto3',
                        optionsAffichage: { positionDuContenu: enumPositionDuContenu.bas },
        ...
        }, 2, ice2LabelContainer);

        ajouter('ice2LabelContainer', 'Un container qui permet d\'associer un xlabel à un autre élément', function (ici: xElementHolder) {
            ici.ice2LabelContainer({
        ...
        ajouter('ice2LabelContainer', 'ice2LabelContainer en mode vertical', function (ici: xElementHolder) {
            ici.ice2LabelContainer({
                optionsAffichage: { positionDuContenu: enumPositionDuContenu.bas },
                textVariable: 'bonjour',
                initContent: new ice2Bouton({
        ...
        ajouter('ice2LabelContainer', 'ice2LabelContainer avec le label à droite du contenu', function (ici: xElementHolder) {
            ici.ice2LabelContainer({
                textVariable: 'bonjour',
        ...
        ajouter('ice2LabelContainer', 'ice2LabelContainer en mode vertical avec le label en dessous du contenu', function (ici: xElementHolder) {
            ici.ice2LabelContainer({
        ...
        ajouter('ice2LabelContainer', 'ice2LabelContainer avec un label de type titre', function (ici: xElementHolder) {
            ici.ice2LabelContainer({
                textVariable: 'bonjour',
        ...
        ajouter('ice2LabelContainer', 'Un container qui permet d\'associer un xlabel à un autre élément avec un post ajout', function (ici: xElementHolder) {

            let lc = new ice2LabelContainer({ textVariable: 'bonjour' });
            ici.append(lc)
                .append(new ice2Bouton({
                    titleVariable: 'ajout', textVariable: 'ajouter contenu', click: function (cb) {
                        lc.append(new ice2Label({ textVariable: 'parfait!' }));
                    }
                }));
        }, 2, ice2LabelContainer);

        let surbrillance: string = '';
        ajouter('ice2LabelContainer', 'Un container qui permet de mettre le label en surbrillance (ex : onClick: () => { ice2Label.setSurbrillance(\'bonjour\')}))', function (ici: xElementHolder) {
            let lc = new ice2LabelContainer({
                textVariable: 'bonjour',
        ...
        ajouter('ice2LabelModifiable', 'zone texte qui réagit comme un input après dbclic', function (ici: xElementHolder) {
            ici.ice2LabelModifiable({ textVariable: 'texte initial', change: function (s: string) { alert("nouvelle valeur:" + s); } });
        }, 2, ice2LabelModifiable);

        ajouter('ice2LabelModifiable', 'zone texte qui réagit comme un input après dbclic en mode titre', function (ici: xElementHolder) {
            ici.ice2LabelModifiable({ textVariable: 'texte initial', type: enumTypeLabel.standard, change: function (s: string) { alert("nouvelle valeur:" + s); } });
        }, 2, ice2LabelModifiable);

        ajouter('ice2LabelTimeModifiable', '', ici => {
            ici.append(new ice2LabelTimeModifiable({
                libelleLabelSiVide: "00:00",
                textVariable: "02:35",
                change: time => {
                    iceOutils.afficherMessageAlertifySuccess("Heures : " + time.Heures + " Minutes : " + time.Minutes);
                },
                type: enumTypeLabel.standard,
                id: "TimeModif"
            }));
        }, 2, ice2LabelTimeModifiable);

        ajouter('ice2WrapPanel', 'Container qui empile les éléments l\'un à la suite de l\'autre avec retour à la ligne automatique', function (ici: xElementHolder) {
            let wrap = new ice2WrapPanel({
                id: "monWrap",
                class: "stylePanels",
                initContent: [new ice2Label({ textVariable: 'coucou' }), new ice2Label({ textVariable: 'MR Smith ' })]
            });

            ici.append(wrap);

            wrap.append(new ice2Bouton({
        ...
        ajouter('ice2WrapPanel', 'Container qui empile les éléments l\'un à la suite de l\'autre sans retour à la ligne', function (ici: xElementHolder) {
            let wrap = new ice2WrapPanel({
                id: "monWrapNoReturn",
                class: "stylePanels",
                retourALaLigne: false,
        ...
        ajouter('ice2StackPanel', 'Container qui empile les éléments l\'un en dessous de l\'autre', function (ici: xElementHolder) {
            let wrap = new ice2StackPanel({
                id: "monStack",
                class: "stylePanels",
                initContent: [new ice2Label({ textVariable: 'coucou' }), new ice2Label({ textVariable: 'MR Smith ' })]
            });
        ...
        ajouter('ice2ZoneModulable', 'Container divisé en deux permettant de régler la taille entre les deux zones', function (ici: xElementHolder) {

            ici.ice2ZoneModulable({
                class: "ice2ZoneModulableShowroom",
        ...
        ajouter('ice2ZoneModulable', 'Container divisé en deux permettant de régler la taille entre les deux zones sans rotation', function (ici: xElementHolder) {
        ...
        ajouter('ice2ZoneModulable', 'Zone modulable avec une position initiale de 20% pour la zone de gauche (initPosition:20%)', function (ici: xElementHolder) {
        ...
        ajouter('ice2ZoneModulable', 'Container diviser en deux verticalement permettant de régler la taille entre les deux zones (typeOrientation:vertical)', function (ici: xElementHolder) {
        ...
        ajouter('ice2ToolTip', 'ice2Tooltip Mode Hover exemple', function (ici: xElementHolder) {
            ici.ice2ToolTip({
                initContent: new ice2Label({ textVariable: "test tooltip" }),
                toolTipContent: new ice2StackPanel({
                    initContent: [
                        new ice2Label({ textVariable: "contenu du tooltip" }),
                        new ice2Bouton({
        ...
        ajouter('ice2ToolTip', 'ice2Tooltip Mode Hover exemple position au dessus', function (ici: xElementHolder) {
            ici.ice2ToolTip({
                initContent: new ice2Label({ textVariable: "test tooltip au dessus" }),
                toolTipContent: new ice2Label({ textVariable: "ToolTipPositionHeight à enumXxToolTipPositionHeight.haut donne le contenu du tooltip au dessus (si il y a la place)" }),
                ToolTipPositionHeightSouhaite: enumXxToolTipPositionHeight.haut
            })
        }, 2, ice2ToolTip);

        ajouter('ice2ToolTip', 'ice2Tooltip Mode Hover with Header', function (ici: xElementHolder) {
            ici.ice2ToolTip({
                titreHeaderLocalise: "Enregistrement :",
                contenuFooter: new ice2Bouton({ textLocalise: "Marquer comme lu", titleLocalise: "Bouton de test", icone: new IconeP12(enumIconeP12.etat_vu), optionsAffichage: { margin: { Tous: 0 } }, click: function (cb) { cb(); } }),
                initContent: new ice2Label({ textVariable: "test tooltip" }),
                toolTipContent: new ice2StackPanel({
                    initContent: [
                        new ice2Label({ textVariable: "contenu du tooltip" }),
        ...
        ajouter('ice2ToolTipBouton', 'ice2TooltipBouton exemple', function (ici: xElementHolder) {
            ici.append(new ice2ToolTipBouton({
        ...
        ajouter('ice2ToolTipBouton', 'ice2TooltipBouton sans backGround exemple', function (ici: xElementHolder) {
            ici.append(new ice2ToolTipBouton({
                textVariable: "test tooltip",
                titleVariable: "test tooltip",
        ...
        ajouter('ice2ToolTip', 'ice2Tooltip notAbsolute', function (ici: xElementHolder) {
            ici.append(new ice2ToolTip({
                initContent: new ice2Label({ textVariable: "test tooltip" }),
        ...
        ajouter("ice2Volet", "", (ici) => {
            let div: iceDiv = new iceDiv({
                textVariable: "Le conteneur du volet"
            })

            let volet = new ice2Volet({
                initContent: [new ice2Label({ textVariable: "Le volet" })],
                onClose: () => { },
        ...
        ajouter('ice2ZoneRepliable', '', function (ici: xElementHolder) {
            let zoneRepliable = new ice2ZoneRepliable({
                renderTitre: function (titre) {
                    titre.append(new ice2Label({ textVariable: "Je suis une zone repliable", type: enumTypeLabel.titre }));
                },
                renderDetail: function (details, plier) {
                    details.append(new ice2Label({ textVariable: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. <br/> Quisque volutpat sit amet risus id faucibus. <br/> Curabitur finibus ut ipsum laoreet dictum. <br/> Cras vehicula ex quis ligula rutrum consequat. <br/>" }));
                    details.append(new ice2Bouton({
        ...
        ajouter('ice2PlanningBis', 'Planning Dates', (ici: xElementHolder) => {
            ...
            let planningBis = new ice2Planning({
        ...
        ajouter('ice2PlanningBis', 'Planning Ressources', ici => {
        ...
        ajouter('ice2PlanningBis', 'Drag&Drop, agrandissement', ici => {
        ...
        ajouter('ice2Planneur', 'Affiche des rdv asociés à une ressource en fonction du temps ', function (ici: xElementHolder) {
        ...
        ajouter("ice2InputSpeech", "Input avec reconnaissance vocale", function (ici: xElementHolder) {
            //ici.append(new ice2InputSpeech({}));
        }, 2, ice2InputSpeech);

        ajouter("ice2Zoom", "enumAffichageZoom : modeSlider", ici => {
            ici.append(new ice2Zoom({
                afterZoom: (zoom) => {
                    iceOutils.afficherMessageAlertifyLog("Le zoom choisi : " + zoom.toString());
                },
                niveauxZoomPerCent: [25, 50, 75, 100, 125, 150, 175, 200]
            }))
        }, 2, ice2Zoom);

        ajouter("ice2Zoom", "enumAffichageZoom : modeListeHorizontale", ici => {
            ici.append(new ice2Zoom({
                afterZoom: (zoom) => {
                    iceOutils.afficherMessageAlertifyLog("Le zoom choisi : " + zoom.toString());
                },
        ...
        ajouter("ice2Zoom", "enumAffichageZoom : modeListeVerticale", ici => {
            ici.append(new ice2Zoom({
                afterZoom: (zoom) => {
                    iceOutils.afficherMessageAlertifyLog("Le zoom choisi : " + zoom.toString());
                },
        ...
        ajouter("ice2QrCodeReader", "mode onDetect", ici => {
            let q = new ice2QrCodeReader({
                onDetect: (s) => {
                    iceOutils.afficherMessageAlertifySuccess(s);
                    q.stop();
                }
            });
            let c = new ice2Bouton({
                textVariable: 'go',
        ...
        ajouter("ice2QrCodeReader", "mode binding", ici => {
            let b = new BindableObject<string>();

            let q = new ice2QrCodeReader({ binding: { value: b } });
            let l = new ice2Label({ binding: { value: b } });
        ...
        ajouter('ice2ProgressBar', "Barre de progression avec titre: Elements validés et nbTotalElements: 50", function (ici: xElementHolder) {
            let barreProgression: ice2ProgressBar;
            let nb = 0;
            let stackPanel: ice2StackPanel = new ice2StackPanel({
                initContent: [
                    new ice2Bouton({
                    ...
                    barreProgression = new ice2ProgressBar({
                        nbTotalElements: 50,
        ...
        ajouter('ice2xListeDeroulanteAutomatique', "Affichage d'une liste déroulante automatique avec 3 éléments (max 3 : boutton radio sinon liste)", function (ici: xElementHolder) {

            ici.append(new ice2ListeDeroulanteAutomatique({
                data: ["1", "2", "3"],
                libelle: "Test",
        ...
        }, 3, ice2ListeDeroulanteAutomatique);

        ajouter('ice2xListeDeroulanteAutomatique', "Affichage d'une liste déroulante automatique avec 4 éléments (max 3 : boutton radio sinon liste)", function (ici: xElementHolder) {
        ...
        ajouter('liste des icones existantes', 'cliquez sur le bouton', function (ici: xElementHolder) {
            ...
            let a = new ice2WrapPanel({ class: "wrapIconesShowroom" });
            ici.append(a);

            let listeIcones: string[] = iceOutils.enumNamesToStringArray(enumIconeP12);

            listeIcones.forEach((val: string) => {

                let iconeTemp = new IconeP12(iceOutils.stringToEnum<enumIconeP12>(val, enumIconeP12));
                a.append(new ice2Bouton({
        ...
        ajouter('liste des mini icones existantes', 'Survolez pour les noms', function (ici: xElementHolder) {
            ...
            listeIcones.forEach((val: string) => {
                a.append(new IconeMiniP12(iceOutils.stringToEnum<enumIconeP12>(val, enumIconeP12)));
            });
        }, 5);
        ...
        ajouter('liste des icones svg existantes', 'Survolez pour les noms', function (ici: xElementHolder) {
            ...
            let listeIconesSvg: string[] = iceOutils.enumNamesToStringArray(enumIconeSvg);

            listeIconesSvg.forEach((val: string) => {
                a.append(new IconeSvg(iceOutils.stringToEnum<enumIconeSvg>(val, enumIconeSvg)));
            });
        }, 5);
        ...
        ajouter('liste des icones tuile existantes', 'Survolez pour les noms', function (ici: xElementHolder) {
            ...
            let listeIconesTuile: string[] = iceOutils.enumNamesToStringArray(enumIconeTuile);

            listeIconesTuile.forEach((val: string) => {
                a.append(new IconeSvg(iceOutils.stringToEnum<enumIconeTuile>(val, enumIconeTuile)));
            });
        }, 5);

        ajouter('ice2Charts', 'Graphique camembert', function (ici: xElementHolder) {

            ici.append(divChartCamembert);
        }, 6);


        ajouter('ice2Charts bar', 'Graphique en bar', function (ici: xElementHolder) {
        ...
        function initChart(divChart: iceDiv, divChartBar: iceDiv) {
            ...
            let chart: mChart.ice2Chart = new mChart.ice2Chart({ data: datasChart, title: "Gâteau au chocolat", desc: "Répartition par ingrédients", divContenant: divChart });
            ...
            let chartBar: mChart.ice2BarChart = new mChart.ice2BarChart({
                id: 'gogo',
        ...
        ajouter('ice2Bouton', 'Bouton Generator', function (ici: xElementHolder) {
            // THE grid //
            let gridGenerator: ice2Grid = new ice2Grid({
                colonnes: ["auto"],
                lignes: ["auto"],
                gridGap: "5px",
                class: "GridGenerator"
            ...
            // Contenue
            let DivTempoBouton: iceDiv = new iceDiv({});
            ...
            function GenerationBouton() {
                ...
                if (isCheckbox) {
                    DivTempoBouton.asHolder.append(new ice2CheckBox({
                    ...
                    optionString = "new ice2CheckBox(" + optionString + ")";
                }
                else {
                    DivTempoBouton.asHolder.append(new ice2Bouton(optionboutonTempo));
                    ...
                    optionString = "new ice2Bouton(" + optionString + ")";
                }
            ...
            //#region optionGlobal
            let ZoneOptionGlobal: ice2ZoneRepliable = new ice2ZoneRepliable({
                renderTitre: (ici) => {
                    ici.append(new ice2Label({
                ...
                renderDetail: (ici) => {
                    let gridOptionGlobal: ice2Grid = new ice2Grid({
                    ...
                    gridOptionGlobal.append([new ice2GridItem({
                        colStart: 2,
                        nbCols: 1,
                        rowStart: ligneOption,
                        class: "LabelOption",
                        content: new ice2LabelContainer({
                            textVariable: "Texte",
                            optionsAffichage: { positionDuContenu: enumPositionDuContenu.bas },
                            initContent: new xInputText({
                    ...
                    gridOptionGlobal.append([new ice2GridItem({
                        ...
                        content: new ice2LabelContainer({
                            ...
                            optionsAffichage: { positionDuContenu: enumPositionDuContenu.bas },
                            initContent: new ice2ListeDeroulante<enumTypeBouton>({
                                ...
                                selected: (val) => {
                                    ...
                                    switch (val) {
                                        case enumTypeBouton.Standard:
                                            cachericeElements(ZoneOptionLabel, true);
                                        ...
                                        case enumTypeBouton.TexteHorsBouton:
                                            affichericeElements(ZoneOptionLabel);
                    ...
                    gridOptionGlobal.append([new ice2GridItem({
                        ...
                        content: new ice2LabelContainer({
                            ...
                            optionsAffichage: { positionDuContenu: enumPositionDuContenu.bas },
                            initContent: new ice2ListeDeroulante<string>({
                    ...
                    new ice2GridItem({
                        ...
                        content: new ice2LabelContainer({
                            textVariable: "Icone",
                            optionsAffichage: { positionDuContenu: enumPositionDuContenu.bas },
                            initContent: new ice2ListeDeroulante<number>({
                                donnees: [],
                    ...
                    gridOptionGlobal.append([new ice2GridItem({
                        ...
                        content: new ice2LabelContainer({
                            ...
                            optionsAffichage: { positionDuContenu: enumPositionDuContenu.bas },
                            initContent: new ice2ListeDeroulante<enumComportementBouton>({
            ...
            //#region optionLabel
            let ZoneOptionLabel: ice2ZoneRepliable = new ice2ZoneRepliable({
                renderTitre: (ici) => {
                    ici.append(new ice2Label({
                ...
                CouleurFleche: enumXxZoneRepliableCouleurFleche.Blanc,
                renderDetail: (ici) => {
                    let gridOption: ice2Grid = new ice2Grid({
                        colonnes: ["15%", "auto", "auto", "auto", "auto", "15%"],
                        lignes: ["auto"],
                        gridGap: "20px 10px",
                    });
                    ...
                    // type - C 2 > 2
                    gridOption.append([new ice2GridItem({
                        colStart: 2,
                        nbCols: 1,
                        rowStart: ligneOption,
                        class: "LabelOption",
                        content: new ice2LabelContainer({
                            textVariable: "Type",
                            optionsAffichage: { positionDuContenu: enumPositionDuContenu.bas },
                            initContent: new ice2ListeDeroulante<enumTypeLabel>({
                                donnees: [],
                                asyncLoading: async () => {
  ...
  titleVariable: enumTypeLabel[item],
                    ...
                    gridOption.append([new ice2GridItem({
                        ...
                        content: new ice2LabelContainer({
                            ...
                            optionsAffichage: { positionDuContenu: enumPositionDuContenu.bas },
                            initContent: new ice2ListeDeroulante<enumHabillageLabel>({
                                donnees: [],
                                asyncLoading: async () => {
            ...
            let ZoneOptionAffichage: ice2ZoneRepliable = new ice2ZoneRepliable({
                renderTitre: (ici) => {
                    ici.append(new ice2Label({
                ...
                renderDetail: (ici) => {
                    ...
                    gridOption.append([new ice2GridItem({
                        ...
                        content: new ice2LabelContainer({
                            ...
                            optionsAffichage: { positionDuContenu: enumPositionDuContenu.bas },
                            initContent: new ice2ListeDeroulante<enumStyleBouton>({
                                donnees: [],
                                asyncLoading: async () => {
                    ...
                    gridOption.append([new ice2GridItem({
                        ...
                        content: new ice2LabelContainer({
                            ...
                            optionsAffichage: { positionDuContenu: enumPositionDuContenu.bas },
                            initContent: new ice2ListeDeroulante<enumTailleBouton>({
                                donnees: [],
                                asyncLoading: async () => {
                    ...
                    gridOption.append([new ice2GridItem({
                        ...
                        content: new ice2LabelContainer({
                            ...
                            optionsAffichage: { positionDuContenu: enumPositionDuContenu.bas },
                            initContent: new ice2ListeDeroulante<enumCouleurBouton>({
                                donnees: [],
                                asyncLoading: async () => {
                    ...
                    gridOption.append([new ice2GridItem({
                        ...
                        content: new ice2LabelContainer({
                            ...
                            optionsAffichage: { positionDuContenu: enumPositionDuContenu.bas },
                            initContent: new ice2ListeDeroulante<enumPositionnementResponsiveBouton>({
                                donnees: [],
                                asyncLoading: async () => {
                    ...
                    gridOption.append([new ice2GridItem({
                        ...
                        content: new ice2LabelContainer({
                            ...
                            optionsAffichage: { positionDuContenu: enumPositionDuContenu.bas },
                            initContent: new ice2ListeDeroulante<enumPosition>({
                                donnees: [],
                                asyncLoading: async () => {
            ...
            gridGenerator.append([new ice2GridItem({
                colStart: 1,
                nbCols: 10,
                class: "TitreGrid",
                rowStart: ligne++,
        ...
        ajouter('iceInputDate', 'binding: {value: BindableObject<Date>, visibility: BindableObject<enumVisibility> }', ici => {
            let dateB = new BindableObject<DateSerialisable>();
            let visiB = new BindableObject<enumVisibility>(enumVisibility.afficher);


            ici.append(new iceInputDate({
            ...
            dateB.bind(d => {
                stringB.Value = DateSerialisable.tolocalStringOnlyDate(d) //iceOutils.DateToFrenchDateString(d, false, false);
            })
        ...
        ajouter('xInputTime', 'binding: {value: BindableObject<iceTime>, visibility: BindableObject<enumVisibility> }', ici => {
            let timeB = new BindableObject<iceTime>();
            let visiB = new BindableObject<enumVisibility>(enumVisibility.afficher);
        ...
        ajouter('ice2AutoComplete', 'binding: {value: BindableObject<T>, visibility: BindableObject<enumVisibility> }', ici => {

            let stringliste = ["un", "deux", "trois", "quatre", "cinq", "six", "sept", "huit", "neuf", "dix"]
            let stringB = new BindableObject<string>("");
            let visiB = new BindableObject<enumVisibility>(enumVisibility.afficher);

            ici.append(new ice2AutoComplete<string>({
        ...
        ajouter('ice2BoutonDeprecated', 'binding: {visibility: BindableObject<enumVisibility>', ici => {
        ...
        ajouter('ice2CheckBox', 'binding: {value: BindableObject<boolean>, visibility: BindableObject<enumVisibility> }', ici => {
            let boolB = new BindableObject<boolean>();
            let visiB = new BindableObject<enumVisibility>(enumVisibility.afficher);

            ici.append(new ice2CheckBox({
                binding: {
                    value: boolB,
                    visibility: visiB
                }
        ...
        ajouter('ice2Label', 'binding: {value: BindableObject<string>, visibility: BindableObject<enumVisibility> }', ici => {
            let stringB = new BindableObject<string>("La valeur de base");
            let visiB = new BindableObject<enumVisibility>(enumVisibility.afficher);
        ...
        ajouter('ice2LabelContainer', 'binding: {value: BindableObject<string>, visibility: BindableObject<enumVisibility> }', ici => {
            let stringB = new BindableObject<string>("La valeur de base");
            let visiB = new BindableObject<enumVisibility>(enumVisibility.afficher);

            ici.append(new ice2LabelContainer({
                binding: {
                    value: stringB,
                    visibility: visiB
                },
        ...
        ajouter('ice2QrCodeReader', 'binding: {value: BindableObject<string>, visibility: BindableObject<enumVisibility>', ici => {
            let stringB = new BindableObject<string>("La valeur de base");
            let visiB = new BindableObject<enumVisibility>(enumVisibility.afficher);

            ici.append(new ice2QrCodeReader({
                binding: {
                    value: stringB,
                    visibility: visiB
                }
        ...
        ajouter('iceCouleur', 'binding: {value: BindableObject<string>, visibility: BindableObject<enumVisibility>', ici => {
        ...
        ajouter('ice2ChoixCouleur', 'binding: {value: BindableObject<string>, visibility: BindableObject<enumVisibility>', ici => {
        ...
        tableau_ice2Element.ajouterDatas(dataTabice2);
        //     tableau_ice2xElement.ajouterDatas(dataTabice2x);
        ...
        let p: Promise<{}> = new Promise<{}>((setoui, setnon) => {
            setTimeout(function () {
                iceOutils.afficherMessageAlertify("oui", ETypeAlertify.log);
                setoui({});
            }, 10000)
        });


        setTimeout(function () { iceOutils.afficherMessageAlertify("timeout", ETypeAlertify.log); p.then(() => { iceOutils.afficherMessageAlertify("then", ETypeAlertify.log); }) }, 3000);
        ...
        /*
                ...
                let ctrlS: Keypress.Combo =
                {
                    ...
                    on_keydown: function (e: Event) {
                        iceOutils.afficherMessageAlertify("enregistrement en cours", ETypeAlertify.log);
                    },
                    on_keyup: null,
                    on_release: null,
                    this: this,
                ...
                let ctrlP: Keypress.Combo =
                {
                    keys: "meta p",
                    on_keydown: function (e: Event) {
                        iceOutils.afficherMessageAlertify("impression en cours", ETypeAlertify.log);
                    },
                    on_keyup: null,
                    on_release: null,
                    this: this,
