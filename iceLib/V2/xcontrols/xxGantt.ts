...
module mGantt {
   ...
   export class svgElementWrapper {
    ...
    export class xxGantt<T, J> {
        ...
        public draw(inTaches: T[], inJalons: J[], selecteur: string | HTMLElement): xxGantt<T, J> {
            let myThis: xxGantt<T, J> = this;
...
//                        .attr('offset', '100%');
        ...
        public drawJalon(j: J): xxGantt<T, J> {
