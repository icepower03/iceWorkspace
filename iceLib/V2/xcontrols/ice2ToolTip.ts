...
interface OptionsToolTip
{
    ...
    renderCustomHeader?: (ici: iXElementHolder, thisTooltip: ice2ToolTip) => void;
    ...
    onShow?: (thisTooltip: ice2ToolTip) => void;
    /* afterShow = juste après l'apparition */
    afterShow?: (thisTooltip: ice2ToolTip) => void;
    onHide?: (thisTooltip: ice2ToolTip) => void;
    /* beforeHide = juste avant le masquage */
    beforeHide?: (thisTooltip: ice2ToolTip) => void;
...
export class ice2ToolTip implements iXElement
{
    // ----------------------- //
    // Static tooltip gestion  //
    // ----------------------- //
    private static TooltipOuvert: ice2ToolTip;
    private static ListeTooltip: ice2ToolTip[] = [];
    ...
    public static ForcerFermetureDeToutesLesTooltips(): boolean
    {
        ...
        if (ice2ToolTip.ListeTooltip.length > 0)
            ice2ToolTip.ListeTooltip.forEach((to) =>
            {
                if (to.isVisible)
                {
                    to.HideTooltip();
    ...
    private elementTooltip: iceDiv;
    private headerDiv: iceDiv;

    private Tooltip_Box_Event: ice2ContainerEvent;
    private Tooltip_Box_Header_Titre: ice2Label;
    private ToolTip_Box_Contenu: iceDiv;

    private Tootip_Contenu: ice2ContainerEvent | iceDiv;
    ...
    public addClass(strClasses: string): ice2ToolTip {
        let myThis: ice2ToolTip = this;
    ...
    public removeClass(strClasses: string): ice2ToolTip {
        let myThis: ice2ToolTip = this;
    ...
    constructor(o: OptionsToolTip)
    {
        ...
        ice2ToolTip.ListeTooltip.push(mythis);
        ...
        if (!!o.titleLocalise)
            mythis.title = new iceLString(o.titleLocalise).text;
        else if (!!o.titleVariable)
            mythis.title = o.titleVariable;

        // Generation des 2 div Principale
        mythis.elementPrincipal = new iceDiv({ id: o.id , class: "ice2Tooltip " + (!!o.class ? o.class : "") });
        mythis.elementTooltip = new iceDiv({ id: (!!o.id ? "Tooltip_Box_#" + o.id : null), class: "ice2Tooltip_Box " + (!!o.class ? o.class : "") });
        ...
        if (o.TooltipMode == enumXxToolTipMode.Manuel)
            mythis.elementTooltip.addClass("ice2Tooltip_Box_With_BackGround");

        if (o.NotAbsoluteTooltip)
            mythis.elementTooltip.addClass("ice2Tooltip_Box_Not_Absolute");
        ...
        if (o.initContent != null)
        {
            ...
            {
                // On ajouter la tooltip au même niveau que les ice2boxer
                document.body.append(mythis.elementTooltip.y);
            }
        }
        else
            console.error("ice2ToolTip => option initContent is undefined");
     ...
     * */
    public viderTooltip(): ice2ToolTip
    {
     ...
     */
    public setToolTip(ttContent: iXElement): ice2ToolTip
    {
        let mythis: ice2ToolTip = this;
    ...
    // Permet la generation du ice2element
    private Generation()
    {
        let mythis: ice2ToolTip = this;

        // init. contenu de elementTooltip
        mythis.ToolTip_Box_Contenu = new iceDiv({ class: "ice2Tooltip_Box_Contenu" });
        ...
        // Ajout des class
        mythis.Tooltip_Box_Event.asHolder.addClass("ice2Tooltip_Box_Event");
        ...
        mythis.Tootip_Contenu.asHolder.addClass("ice2Tooltip_Contenu");
    ...
    private ModeManuel()
    {
        ...
        mythis.elementTooltip.asHolder.append(new iceDiv({
            class: "ice2Tooltip_Box_BackGround",
            click: () =>
            {
                mythis.HideTooltip();
            }
        ...
        // Tooltip_box_Event
        mythis.Tooltip_Box_Event = new ice2ContainerEvent({
        ...
        // tooltip_Contenu
        mythis.Tootip_Contenu = new iceDiv({
            title: mythis.title,
            click: () =>
            {
    ...
    private ModeManuelWithOutBackGround()
    {
        ...
        window.addEventListener("scroll", () =>
        {
            ...
            if (mythis.isShow && !isHover && !ice2ToolTip.IsHoverIndependenteToolTip)
            {
        ...
        mythis.Tooltip_Box_Event = new ice2ContainerEvent({
            ...
            onMouseOver: () =>
            {
                isHover = true;
                if (mythis.lesOption.isIndependenteToolTip)
                    ice2ToolTip.IsHoverIndependenteToolTip = true;
            },
            onMouseOut: () =>
            {
                isHover = false;
                if (mythis.lesOption.isIndependenteToolTip)
                    ice2ToolTip.IsHoverIndependenteToolTip = false;
            },
            onClick: (cb) =>
            {
                if (!mythis.lesOption.TooltipStopPropagation) {
        ...
        // tooltip_Contenu
        mythis.Tootip_Contenu = new ice2ContainerEvent({
    ...
    public setCouleurHeader(newCouleur: enumCouleurHexa)
    {
        ...
        if (mythis.headerDiv != null)
            iceStyle.setCouleurFondAvecContrasteTexteAuto(mythis.headerDiv, newCouleur);
    }
    ...
    {
        let mythis: ice2ToolTip = this;
        let toSender: iceDiv | ice2StackPanel;
        ...
        {
            toSender = new ice2StackPanel({ espaceMinimaliste: true });

            if (WithHeaderTitre) // Header Titre simple
            {
                mythis.elementTooltip.addClass("ice2Tooltip_AvecHeader");

                mythis.headerDiv = new iceDiv({ class: "ice2Tooltip_Box_Header" });
                mythis.Tooltip_Box_Header_Titre = new ice2Label({
            ...
            {
                mythis.elementTooltip.addClass("ice2Tooltip_AvecHeaderCustom");

                let headerCustom: iceDiv = new iceDiv({ class: "ice2Tooltip_Box_Header_Custom" });
            ...
            {
                mythis.elementTooltip.addClass("ice2Tooltip_AvecFooter");

                let footerCustom: iceDiv = new iceDiv({ class: "ice2Tooltip_Box_Footer" });
    ...
    */
    public ShowTooltip()
    {
        ...
        if (!mythis.lesOption.isIndependenteToolTip)
        {
            if (ice2ToolTip.TooltipOuvert != null && ice2ToolTip.TooltipOuvert != mythis)
                ice2ToolTip.TooltipOuvert.HideTooltip();
            ice2ToolTip.TooltipOuvert = mythis;
        }
    ...
    */
    public async HideTooltip()
    {
        ...
        if (!mythis.lesOption.isIndependenteToolTip)
        {
            if (ice2ToolTip.TooltipOuvert == mythis)
                ice2ToolTip.TooltipOuvert = null;            
        }
    ...
    */
    public CalculPosition()
    {
        ...
        // Reset css
        mythis.Tooltip_Box_Event.removeClass("ice2ToolTip_overload");
        ...
        if (mythis.lesOption.ToolTipHeigthFix > 30)
        {
            ...
            mythis.Tooltip_Box_Event.addClass("ice2ToolTip_overload");
        }
    ...
    private get visibleClass(): string
    {
        ...
        if (mythis.isShow)
        { return "ice2TooltipOn"; }
        else
        { return "ice2TooltipOff"; }
    }
    ...
    private refreshClass()
    {
        ...
        mythis.elementTooltip.removeClass("ice2TooltipOn");
        mythis.elementTooltip.removeClass("ice2TooltipOff");
...
export class ice2ToolTipBouton implements iXElement
{
    // --------- //
    // Attributs //
    // --------- //
    private ToolTip: ice2ToolTip;
    ...
    {
        let mythis: ice2ToolTipBouton = this;
        ...
        mythis.Bouton = new ice2Bouton(optionBt);
        ...
        mythis.ToolTip = new ice2ToolTip(opitonTooltip);



        if (o.optionsAffichage != undefined)
        {
            iceStyle.AppliquerOptionsAffichage(mythis.Bouton, o.optionsAffichage);
        }
    }
    ...
    public addClass(c: string):ice2ToolTipBouton {
        let myThis: ice2ToolTipBouton = this;
        myThis.ToolTip.addClass(c);
        return myThis;

    }
    public removeClass(c: string):ice2ToolTipBouton {
        let myThis: ice2ToolTipBouton = this;
