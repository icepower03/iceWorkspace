...
}(this, function ()
{
	...
	var labels = {
		...
		positionLabelElements: function (pie, section, sectionDisplayType)
		{
			...
			var labelGroups = d3.selectAll("#" + pie.element.id + " ." + pie.cssPrefix + "labelGroup-" + section);
			...
			{
				case "label-value1":
					d3.selectAll("#" + pie.element.id + " ." + pie.cssPrefix + "segmentValue-" + section)
				...
				case "label-percentage1":
					d3.selectAll("#" + pie.element.id + " ." + pie.cssPrefix + "segmentPercentage-" + section)
						.attr("dx", function (d, i) { return dims[i].mainLabel.width + singleLinePad; });
					break;
		...
		{
			pie.lineCoordGroups = [];
			d3.selectAll("#" + pie.element.id + " ." + pie.cssPrefix + "labelGroup-outer")
		...
		positionLabelGroups: function (pie, section)
		{
			...
			d3.selectAll("#" + pie.element.id + " ." + pie.cssPrefix + "labelGroup-" + section)
				.style("opacity", 0)
		...
		fadeInLabelsAndLines: function (pie)
		{
			...
			setTimeout(function ()
			{
				...
				d3.selectAll("#" + pie.element.id + " ." + pie.cssPrefix + "labelGroup-inner")
					.transition()
					.duration(labelFadeInTime)
					.style("opacity", function (d, i)
					{
				...
				d3.selectAll("#" + pie.element.id + " g." + pie.cssPrefix + "lineGroups")
					.transition()
					.duration(labelFadeInTime)
					.style("opacity", 1);
	...
	var segments = {
		...
		{
			var arc = d3.selectAll("#" + pie.element.id + " ." + pie.cssPrefix + "arc,." + pie.cssPrefix + "labelGroup-inner,." + pie.cssPrefix + "labelGroup-outer");
		...
		{
			if (d3.selectAll("#" + pie.element.id + " ." + pie.cssPrefix + "expanded").size() > 0)
			{
				segments.closeSegment(pie, d3.select("#" + pie.element.id + "." + pie.cssPrefix + "expanded").node());
			}
		},
	...
	var tt = {
		...
		{
			d3.selectAll("#" + pie.element.id + " #" + pie.cssPrefix + "tooltip" + tt.currentTooltip)
